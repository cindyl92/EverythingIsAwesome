...
namespace  AssemblyCSharpvs
{
	public class BuildingHeight : MonoBehaviour {
		...
		void Start () {
			...
			/*
			 *  set building positions for each package
			 */
			...
			/*
			 *  instantiate and render building objects and apply building position, scale (height and bases), and colour
			...
			/*
			 *  create buiding labels and set them visible from top and side view
			 */
			...
			/* 
			 *  render building objects and apply building position, scale (height and bases), and colour
			 */ 
			...
			//draw lines between coupled classes
			drawLines ();
		...
		/*
		 *  set heights
		 *  range is between 0 to 40 (max lines of code is 2700 which leads to 35.4 of height)
		 */ 
		...
		/*
		 *  set colours based on the comment density
		 *  White	0 - 29 %
		 *  Blue	30 - 59 %
		 *  Black	60 - 100 %
		 */ 
		...
		/*
		 *  set building positions into a box shape
		 * 
		 *  rendering order: 
		 *  4	5	6	
		 *  3		7
		...
		/*
		 *  find packages and save the names into an array: packageName[]
		 *  save number of classes for each index: packages[numPackages] = number of classes
		 */
		void findPackages(){
